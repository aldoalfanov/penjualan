...
<section class="konten">
	<div class="container">
		<center><h3>Tersedia Ayam Kampung dan Ayam Potong</h3></center>
		<br>
		<div class="row">
			<?php $ambil= $koneksi->query("SELECT * FROM ayam LEFT JOIN kategori on ayam.id_kategori=kategori.id_kategori WHERE nama_kategori='Kampung'"); ?>
