...
float: right;
font-size: 16px;"> Akses : <?php echo date('d F Y H:i');  ?> &nbsp; <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust fa fa-sign-out">Logout</a> &nbsp; <a href="index.php?halaman=komentar"><i class="fa fa-comments fa-2x"></i></a></div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a  href="index.php?halaman=ayam"><i class="fa fa-list "></i> Daftar Ayam</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if (isset($_GET['halaman']))
                {
                    ...
                    elseif ($_GET['halaman']=="tambahayam")
                    {
                        include 'tambahayam.php';
                    }
                    elseif ($_GET['halaman']=="hapusayam")
                    {
                        include 'hapusayam.php';
                    }
                    elseif ($_GET['halaman']=="hapuspelanggan")
                    {
                        include 'hapuspelanggan.php';
                    }
                    elseif ($_GET['halaman']=="ubahayam")
                    {
                        include 'ubahayam.php';
                    }
